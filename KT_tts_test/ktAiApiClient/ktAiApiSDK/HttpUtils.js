...
export default class HttpUtils {
    ...
    static DEFAULT_HTTP_PORT = 55175;
    static DEFAULT_GRPC_PORT = 55174;
    ...
    // static mEntryProfilePath = dotenv.config({ path:  __dirname + '/config/.env.server' });
    ...
    requestMutipart2(strUrl, headerJson, mediaMetaData, mediaData) {
        ...
        if(response.statusCode == httpUtils.RESULT_STATUS_CODE_200) {
            ...
            else if(response.headers["content-type"].search("multipart") > -1) {
